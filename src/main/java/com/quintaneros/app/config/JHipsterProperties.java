...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "Quintaneros@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "Quintaneros API";

        private String description = "Quintaneros API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "Quintaneros";
